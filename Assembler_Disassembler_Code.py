...
opcode={'j': 2, 'jal': 3, 'beq': 4, 'bne': 5, 'addi': 8, 'slti': 10, 'andi': 12, 'ori': 13,     #for non-R Type instructions
 'xori': 14, 'lui': 15, 'lb': 32, 'lw': 35,
  'sb': 40, 'sw': 43}


func={'sll': 0, 'slr': 2, 'sra': 3, 'sllv': 4, 'srlv': 6, 'srav': 7, 'jr': 8,  #defining the funct bit correspondence
 'jalr': 9, 'syscall': 12, 'break': 13, 'add': 32, 'sub': 34, 'and': 36, 'or': 37,
...
shift_type=["sll","sra","srl"]                                                      #These are I type as well. But we use a different
